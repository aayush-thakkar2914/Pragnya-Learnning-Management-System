...
<title>Reset Password | Pragnya</title>
            ...
            <div class="w-full md:w-1/2 p-6">
                ...
                <input type="hidden" name="token" value="<%= request.getParameter("token") %>">
                    <div>
                        ...
                        <input type="password" name="new_password" id="new_password" required class="w-full p-2 border rounded hover:bg-gray-100 hover:shadow-sm">
                    ...
                    <button type="submit" class="w-full bg-sky-200 text-black py-2 rounded hover:bg-blue-600 hover:text-white">Reset Password</button>
                </form>
            </div>
        </div>
    </div>
