...
<body class="bg-gray-100 flex flex-col min-h-screen">
	...
	<div class="flex-grow flex items-center justify-center p-10">
		<div class="bg-white rounded-lg shadow-lg w-3/4 flex items-center p-8">
			...
			<!-- Left Side Graphic -->
			<div class="w-1/2">
				<img src="images/loginSide.jpeg" alt="Login Illustration"
					class="w-full h-auto">
			</div>
			...
			<div class="w-1/2 p-6">
				...
				<form action="login" method="post" class="space-y-4">
					...
					<button type="submit"
						class="w-full bg-blue-600 text-white py-2 rounded">Login
					</button>
				</form>
				<div class="flex justify-center pt-4">
					<a href="forgot_password.jsp" class="text-blue-500 text-sm">Forgot
						Password?</a>
				</div>

				<p class="text-center mt-4 text-sm">
					Don't have an account? <a href="signup.jsp" class="text-blue-600">Register</a>
				</p>
			</div>
		</div>
	</div>
